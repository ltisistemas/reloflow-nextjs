...
Reloflow é uma aplicação web moderna para gerenciamento de quadros kanban com autenticação segura. O sistema é composto por um frontend inovador em Next.js e um backend robusto em C# .NET 8.
...
O sistema utiliza um modelo de autenticação seguro baseado em credenciais. Verifique as políticas de segurança no backend .NET.
...
Este repositório segue uma estratégia moderna de branches:

### Desenvolvimento de Features

1. Crie uma nova branch: `git checkout -b feature/sua-feature`
2. Faça seus commits: `git commit -m 'Add some feature'`
3. Faça push da branch: `git push origin feature/sua-feature`
4. **PR automática para `develop`** será criada pelo GitHub Actions

### Processo de Release

1. PR de `develop` para `main` é criada automaticamente após merge
2. Certifique-se de que todos os testes passam antes do merge para produção
...
2. Faça commit de suas mudanças (`git commit -m 'Add some feature'`)
3. Faça push para a branch (`git push origin feature/NovaFeature`)
